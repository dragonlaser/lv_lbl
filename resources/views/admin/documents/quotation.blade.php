        ...
        <htmlpagebody>
            ...
            <div class="row">
                <table class="table_css" style="border-collapse: collapse;">
                    ...
                    <tfoot>
                        <tr>
                            <th colspan="2" style="text-align: left;">* เงื่อนไขการชำระเงิน แบ่งเป็น 4 งวด ระยะเวลาในการจัดทำ 6 เดือน</th>
                            <th colspan="2" style="text-align: right;">ราคารวมสินค้า / Total</th>
                            <th style="text-align: right;">40,000.00</th>
                        </tr>
                        <tr>
                            <th colspan="2" style="text-align: left;">งวดที่ 1 10,700 บาท ( 25% ) ชำระเมื่อเริ่มงาน</th>
                            <th colspan="2" style="text-align: right;">ภาษีมูลค่าเพิ่ม 7% / Vat 7%</th>
                            <th style="text-align: right;">2,700.00</th>
                        </tr>
                        <tr>
                            <th colspan="2" style="text-align: left;">งวดที่ 2 10,700 บาท ( 25% ) ชำระเมื่อ BRD Approved</th>
                            <th colspan="2" style="text-align: right;">จำนวนเงินรวมทั้งสิ้น / Total Price</th>
                            <th style="text-align: right;">42,700.00</th>
                        </tr>
                        <tr>
                            <th colspan="5" style="text-align: left;">งวดที่ 3 10,700 บาท ( 25% ) ชำระเมื่อเริ่ม UAT</th>
                        </tr>
                        <tr>
                            <th colspan="5" style="text-align: left;">งวดที่ 4 10,700 บาท ( 25% ) ชำระเมื่อส่งมอบงาน</th>
                        </tr>
                        <tr>
                            <th colspan="5" style="text-align: left;">พิเศษ Maintenace 1 ปีเต็มหลังจากปิดงาน โดยไม่มีค่าใช่จ่ายใดๆ นับเริ่มตั้งแต่วันปิดงาน</th>
                        </tr>
                    </tfoot>
                </table>
            </div>
