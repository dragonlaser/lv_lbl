var Contacttype = (function () {
    var handleTables = function () {
      var table = $('#contacttype').DataTable({
        "responsive": true,
        "serverSide": true,
        "processing": true,
        "ajax": rurl + 'admin/data_contacttype',
        "columns": [{
            "data": 'DT_RowIndex',
            "name": 'DT_RowIndex',
            orderable: false,
            ...
            className:"text-center"
					...
					{"data":"id","name":"contacttype.id."},
					{"data":"name","name":"contacttype.name."},
        ...
        submitHandler: function(element) {
          ...
          $.ajax({
            ...
            success: function () {
              ...
              $("#contacttype").DataTable().ajax.reload(null, false);
