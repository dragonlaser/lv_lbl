var Frontcontents = (function () {
    var handleTables = function () {
      var table = $('#frontcontents').DataTable({
        "responsive": true,
        "serverSide": true,
        "processing": true,
        "ajax": rurl + 'admin/data_frontcontents',
        "columns": [{
            "data": 'DT_RowIndex',
            "name": 'DT_RowIndex',
            orderable: false,
            ...
            className:"text-center"
					...
					{"data":"title","name":"frontcontents.title."},
        ...
        submitHandler: function(element) {
          ...
          $.ajax({
            ...
            success: function () {
              ...
              $("#frontcontents").DataTable().ajax.reload(null, false);
    ...
    var handleButton = function () {
        ...
        $(document).on('click', '.btn-add', function(){
          ...
          $('.validateForm').removeAttr('data-id')
            //add value to form frontcontents
            $('[name="field_1"]').val('f1')
            $('[name="field_2"]').val('f2')
            $('[name="field_3"]').val('f3')
            $('[name="field_4"]').val('f4')
        ...
        $(document).on('click', '.btn-edit', function(){
          ...
          $.ajax({
            type: 'get',
            url: rurl+'admin/frontcontents/'+id,
            dataType: "json",
