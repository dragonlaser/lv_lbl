      ...
      var table = $('#examples').DataTable({
        ...
        "columns": [{
            ...
            className:"text-center"
					...
					{"data":"field_1","name":"examples.field_1."},
					{"data":"field_2","name":"examples.field_2."},
					{"data":"field_3","name":"examples.field_3."},
					{"data":"field_4","name":"examples.field_4."},
					{"data":"created_by","name":"examples.created_by."},
        ...
        submitHandler: function(element) {
          ...
          $.ajax({
            ...
            success: function () {
              ...
              $("#examples").DataTable().ajax.reload(null, false);
